...
_SEARCH_DESC = (
    ...
    "instagram, pinterest, linkedin, quora, xiaohongshu) take a compact phrase. "
    "Semantic sources (reddit, web, arxiv, github, hackernews, youtube, "
    "bilibili) tolerate longer natural phrasing. The pipeline already strips "
    "question/meta words per source and retries X with shorter variants, so "
    "lead with the core subject. Match query language to platform — Chinese "
